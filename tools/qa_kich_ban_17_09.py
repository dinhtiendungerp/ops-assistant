...
KICH_BAN = [
    ...
    {"so": 3, "ten": "Lô nào sắp hết hạn", "loai": "chat", "text": "lô nào sắp hết hạn", "ai": "trang.sc", "ct": "NWV-MAROU"},
    {"so": 4, "ten": "Phương án Choco pillar S0010", "loai": "chat", "text": "phương án xử lý cho Choco pillar ở S0010", "ai": "trang.sc",
     "ct": "NWV-MAROU", "can_ai": True},
    {"so": "4b", "ten": "Ghi đề xuất theo phương án", "loai": "nut", "verb": "ih_d4_apply", "ai": "trang.sc", "ct": "NWV-MAROU",
     "xem": ["trang.sc", "hung.dieuphoi"]},
    {"so": 5, "ten": "Hùng duyệt chuyển hàng", "loai": "nut", "verb": "approve", "co": "Choco pillar", "ai": "hung.dieuphoi", "ct": "NWV-MAROU"},
